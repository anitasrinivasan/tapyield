...
export default function Deposit() {
  ...
  const usdEquiv = amount
    ? `$${(parseFloat(amount) * XRP_TO_USD).toFixed(2)}`
    : "";
      ...
      <View style={styles.content}>
        ...
        <View style={styles.presets}>
          {presets.map((p) => (
            <TouchableOpacity
              ...
              style={[
                styles.presetBtn,
                amount === p.xrp && styles.presetActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.presetUsd,
                  amount === p.xrp && styles.presetTextActive,
                ]}
              >
                {p.usd}
              </Text>
        ...
        >
          {loading ? (
            ...
            <Text style={styles.buttonText}>Deposit {usdEquiv || ""}</Text>
          )}
        </TouchableOpacity>
      </View>
    </SafeAreaView>
